...
function krabs(request, reply, handle, app, config) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, tenants, enableVhostHeader, _b, vhostHeader, rawHostname, pathName, query, hostname, host, tenant, route;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 3:
                    ...
                    route = (0, resolve_1["default"])(tenant === null || tenant === void 0 ? void 0 : tenant.name, pathName);
                    if (route) {
                        // @ts-ignore
