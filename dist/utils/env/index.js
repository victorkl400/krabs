...
exports.currentEnv = (_a = process.env) === null || _a === void 0 ? void 0 : _a.KRABS_ENV;
exports.safeEnv =
  exports.currentEnv !== null && exports.currentEnv !== void 0 ? exports.currentEnv : 'development';
exports.environmentWarningMessage = [
  '\n\u26A0\uFE0F   ' + 'Warning' + '\n',
  'The ' + 'KRABS_ENV' + ' environment variable is ' + 'undefined' + '.',
